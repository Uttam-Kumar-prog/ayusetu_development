...
router.post(
  ...
  body('symptoms.*.durationDays').optional().isInt({ min: 0, max: 3650 }).withMessage('durationDays must be between 0 and 3650'),
  body('symptoms.*.notes').optional().isString().isLength({ max: 400 }).withMessage('symptom notes must be at most 400 characters'),
